...
export default function AboutPage() {
  ...
  //   >
  //     <h3 className="mb-4 text-xl font-semibold tracking-tight md:text-3xl">
  //       Адреса:
  //     </h3>
  ...
  //           </h3>
  //           {/* <div className="relative flex aspect-video w-full items-center justify-center overflow-hidden rounded-t-md bg-gray-100">
  //             Барбершоп */}
  //           {/* <Image
  ...
  //             /> */}
  //           {/* </div> */}
  //           {/* <div className="relative flex aspect-video w-full items-center justify-center overflow-hidden rounded-b-md bg-gray-100">
  //             {/* Яндекс.Карты */}
  //           {/* <Image
  //               className="object-cover"
  //               fill
